...
public class Main {
    public static void main(String[] args) {
        ...
        studentInfo.testStudent(list, student -> student.age > 25);
        System.out.println("---------------------------");
        studentInfo.testStudent(list, student -> student.age < 25);
        System.out.println("---------------------------");
        studentInfo.testStudent(list, student -> student.avgGrade < 80);
        System.out.println("---------------------------");
        studentInfo.testStudent(list, student -> student.avgGrade > 80);
        System.out.println("---------------------------");
        studentInfo.testStudent(list, student -> student.sex=='f');
    }
}
